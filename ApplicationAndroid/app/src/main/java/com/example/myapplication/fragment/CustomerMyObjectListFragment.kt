...
import com.example.myapplication.databinding.FragmentCustomerMyObjectListBinding
import com.example.myapplication.model.getDataObjects

class CustomerMyObjectListFragment : Fragment() {

    private var _binding: FragmentCustomerMyObjectListBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentCustomerMyObjectListBinding.inflate(inflater, container, false)
        return binding.root
