$(document).ready(function () {
    // zero table
    $('#zero_configuration_table, #zero_configuration_table1, #zero_configuration_table2, #tab_gain, #tab_exploitation, #zero_configuration_table_customer, #tab_subs').DataTable();
